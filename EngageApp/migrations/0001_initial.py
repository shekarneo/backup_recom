# Generated by Django 3.1.6 on 2021-03-10 09:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('vc_main_title', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_event_location', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_city', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_state', models.CharField(blank=True, max_length=200, null=True)),
                ('country', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_status', models.CharField(blank=True, max_length=200, null=True)),
                ('db_registrationCharge', models.FloatField(blank=True, null=True)),
                ('db_registrationTax', models.FloatField(blank=True, null=True)),
                ('db_registrationTotal', models.FloatField(blank=True, null=True)),
                ('vc_eventBanner', models.CharField(blank=True, max_length=300, null=True)),
                ('vc_description', models.CharField(blank=True, max_length=5000, null=True)),
                ('vc_backgroundImage', models.CharField(blank=True, max_length=300, null=True)),
                ('vc_agenda_link', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_brochure_link', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_floorPlan_link', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_eventType', models.CharField(blank=True, max_length=200, null=True)),
                ('vc_eventCreatedEmpId', models.CharField(blank=True, max_length=200, null=True)),
                ('dt_eventCreatedEmpDatetime', models.DateTimeField(blank=True, null=True)),
                ('dt_lastModifiedEmpId', models.CharField(blank=True, max_length=200, null=True)),
                ('dt_lastModifiedDatetime', models.DateTimeField(blank=True, null=True)),
                ('vc_virtualPartner', models.CharField(blank=True, max_length=200, null=True)),
                ('req_conference', models.BooleanField(blank=True, default=True, null=True)),
                ...
                ('about_bg', models.CharField(blank=True, max_length=100, null=True)),
                ('event_date', models.CharField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coupen', models.CharField(default='', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('vc_event_images', models.CharField(blank=True, max_length=200, null=True)),
                ('image_description', models.CharField(blank=True, max_length=200, null=True)),
                ('event_id', models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, to='EngageApp.eventdetails')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.SET_NULL, to='EngageApp.masterevent'),
        ),
        migrations.CreateModel(
            name='EventDelegates',
            fields=[
